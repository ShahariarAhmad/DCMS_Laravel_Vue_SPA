     ...
     <side-bar></side-bar>
        <div class="col-span-8 p-5 ">
            ...
            <div class="grid grid-cols-12 gap-5">
                <!-- card  -->
                <div class="col-span-6 shadow-xl rounded-lg">
                    <div class="grid grid-cols-12 grid-rows-2">
                        ...
                        <div class="col-span-7 row-span-2">
                            <span class="indent-4">
                                <p class="font-semibold">Shahariar Ahmad <small>( 25 )</small> </p>
                                <p>5"8'</p>
                                <address class="text-xs">
                                    <p>Transaction Id: 5M414PCF01</p>
                                    <p>Amount Sent: 500/=</p>
                                    <p>Sent From: +880-115-5559-639</p>
                                    <p>Sent To: +88-0171-0000-111</p>
                                </address>
